...
#SBATCH --time 40:0:0 
#SBATCH --mem 40G 
#SBATCH --job-name binary_1step1_phenotype_rheumatoid_arthritis
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
	...
	--phenoFile /rds/projects/g/gkoutosg-variant-prediction/Yuxi/phenotypic_data/phenotype_rheumatoid_arthritis.phen \
	...
	--threads 15 \
	--out phenotype_rheumatoid_arthritis_step1 
