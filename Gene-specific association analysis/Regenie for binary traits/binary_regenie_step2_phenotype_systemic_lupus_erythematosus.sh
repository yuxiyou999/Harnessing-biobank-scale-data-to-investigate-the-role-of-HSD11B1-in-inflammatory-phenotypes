...
#SBATCH --time 40:0:0
#SBATCH --mem 25G
#SBATCH --job-name binary_step2_phenotype_systemic_lupus_erythematosus
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
    ...
    --phenoFile /rds/projects/g/gkoutosg-variant-prediction/Yuxi/phenotypic_data/phenotype_systemic_lupus_erythematosus.phen \
    ...
    --pred phenotype_systemic_lupus_erythematosus_step1_pred.list \
    --lowmem /rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/tmp \
    --bsize 400 \
    --split \
    --threads 5 \
    --out results/phenotype_systemic_lupus_erythematosus_chr1_HSD11B1_step2
