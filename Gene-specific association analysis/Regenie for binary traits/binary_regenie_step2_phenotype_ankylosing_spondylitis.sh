...
#SBATCH --time 40:0:0
#SBATCH --mem 25G
#SBATCH --job-name binary_step2_phenotype_ankylosing_spondylitis
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
    ...
    --pred phenotype_ankylosing_spondylitis_step1_pred.list \
    --lowmem /rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/tmp \
    --bsize 400 \
    --split \
    --threads 5 \
    --out results/phenotype_ankylosing_spondylitis_chr1_HSD11B1_step2
