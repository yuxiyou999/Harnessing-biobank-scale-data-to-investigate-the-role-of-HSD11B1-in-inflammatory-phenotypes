...
#SBATCH --time 40:0:0 
#SBATCH --mem 40G 
#SBATCH --job-name binary_1step1_phenotype_other_chronic_obstructive_pulmonary_disease
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
	--step 1 \
	--bed /rds/projects/g/gkoutosg-variant-prediction/Yuxi/GWAS/ukb_dataset/subset1 \
	...
	--threads 15 \
	--out phenotype_other_chronic_obstructive_pulmonary_disease_step1 
