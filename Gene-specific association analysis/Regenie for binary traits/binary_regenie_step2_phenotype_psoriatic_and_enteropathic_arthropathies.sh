...
#SBATCH --time 40:0:0
#SBATCH --mem 25G
#SBATCH --job-name binary_step2_phenotype_psoriatic_and_enteropathic_arthropathies
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
    ...
    --phenoFile /rds/projects/g/gkoutosg-variant-prediction/Yuxi/phenotypic_data/phenotype_psoriatic_and_enteropathic_arthropathies.phen \
    ...
    --pred phenotype_psoriatic_and_enteropathic_arthropathies_step1_pred.list \
    --lowmem /rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/tmp \
    --bsize 400 \
    --split \
    --threads 5 \
    --out results/phenotype_psoriatic_and_enteropathic_arthropathies_chr1_HSD11B1_step2
