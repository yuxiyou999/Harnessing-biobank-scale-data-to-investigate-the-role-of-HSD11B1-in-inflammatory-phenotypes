...
#SBATCH --time 40:0:0
#SBATCH --mem 25G
#SBATCH --job-name binary_step2_phenotype_ulcerative_colitis
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
    ...
    --pred phenotype_ulcerative_colitis_step1_pred.list \
    --lowmem /rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/tmp \
    --bsize 400 \
    --split \
    --threads 5 \
    --out results/phenotype_ulcerative_colitis_chr1_HSD11B1_step2
