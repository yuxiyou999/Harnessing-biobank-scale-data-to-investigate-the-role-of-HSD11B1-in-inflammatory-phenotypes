...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
    ...
    --phenoFile /rds/projects/g/gkoutosg-variant-prediction/Yuxi/phenotypic_data/phenotypeLINEAR_Red_blood_cell_count.phen \
    ...
    --pred phenotypeLINEAR_Red_blood_cell_count_step1_pred.list \
    --lowmem /rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/tmp \
    --bsize 400 \
    --split \
    --threads 5 \
    --out results/phenotypeLINEAR_Red_blood_cell_count_chr1_HSD11B1_step2
