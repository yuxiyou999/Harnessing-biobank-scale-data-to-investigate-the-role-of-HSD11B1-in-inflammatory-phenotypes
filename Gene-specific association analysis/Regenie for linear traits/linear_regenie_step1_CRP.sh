...
#SBATCH --time 40:0:0 
#SBATCH --mem 40G 
#SBATCH --job-name linear_step1_phenotype_CRP 
...
/rds/projects/k/karwatha-rate-af/datacentre/GWAS/regenie/regenie \
	...
	--phenoFile /rds/projects/g/gkoutosg-variant-prediction/Yuxi/phenotypic_data/phenotypeLINEAR_CRP.phen \
